...
# rectangles doesnt intersect when -> one rect lowerside is above another rect upper side
# -> one rect left side is outer of another rect rigth side
def fun_rectangle_overlap(left1, top1, width1, height1, left2, top2, width2, height2):
    r1_top = top1 + height1
    r1_left = left1 + width1
    if r1_top > top2 or r1_left < left2:
        return False
    return True
